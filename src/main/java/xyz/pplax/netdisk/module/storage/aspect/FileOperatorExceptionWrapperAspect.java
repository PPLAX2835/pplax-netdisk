...
public class FileOperatorExceptionWrapperAspect {
	...
	@AfterThrowing(throwing = "error", value = "execution(public * xyz.pplax.netdisk.module.storage.service.base.AbstractBaseFileService.newFolder(..))")
	...
	@AfterThrowing(throwing = "error", value = "execution(public * xyz.pplax.netdisk.module.storage.service.base.AbstractBaseFileService.delete*(..))")
	...
	@AfterThrowing(throwing = "error", value = "execution(public * xyz.pplax.netdisk.module.storage.service.base.AbstractBaseFileService.rename*(..))")
	...
	@AfterThrowing(throwing = "error", value = "execution(public * xyz.pplax.netdisk.module.storage.service.base.AbstractBaseFileService.getDownloadUrl(..))")
	...
	@AfterThrowing(throwing = "error", value = "execution(public * xyz.pplax.netdisk.module.storage.service.base.AbstractBaseFileService.getUploadUrl(..))")
	...
	@AfterThrowing(throwing = "error", value = "execution(public * xyz.pplax.netdisk.module.storage.service.base.AbstractProxyTransferService.uploadFile(..))")
	...
	@AfterThrowing(throwing = "error", value = "execution(public * xyz.pplax.netdisk.module.storage.service.base.AbstractProxyTransferService.downloadToStream(..))")
	...
	@AfterThrowing(throwing = "error", value = "execution(public * xyz.pplax.netdisk.module.storage.service.base.AbstractBaseFileService.getFileItem(..))")
