...
import xyz.pplax.netdisk.module.storage.model.enums.FileOperatorTypeEnum;
...
public class FileOperatorCheckAspect {
	 ...
	 * @return  方法运行结果
	 */
	@Around("execution(public * xyz.pplax.netdisk.module.storage.service.base.AbstractBaseFileService.newFolder(..))")
	 ...
	 * @return  方法运行结果
	 */
	@Around("execution(public * xyz.pplax.netdisk.module.storage.service.base.AbstractBaseFileService.delete*(..))")
	 ...
	 * @return  方法运行结果
	 */
	@Around("execution(public * xyz.pplax.netdisk.module.storage.service.base.AbstractBaseFileService.getUploadUrl(..))")
	 ...
	 * @return  方法运行结果
	 */
	@Around("execution(public * xyz.pplax.netdisk.module.storage.service.base.AbstractBaseFileService.rename*(..))")
